...
int _tmain(int argc, _TCHAR *argv[])
{
	...
	input = L"C://Users//Orkhan ALIYEV//Desktop//deneme//indir.bmp"; // bu path dosya yuklemek icin
	...
	if ((ch == 'E') || (ch == 'e'))
	{
		...
		output = L"C://Users//Orkhan ALIYEV//Desktop//deneme//copy.bmp"; // but path dosyayi kaydetmek icin
